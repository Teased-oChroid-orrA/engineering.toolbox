...
{#if open}
  <div class="fixed inset-0 z-50 flex items-center justify-center p-6 relative" role="dialog" aria-modal="true" aria-label="Regex generator" tabindex="-1" transition:fade={{ duration: uiAnimDur }}>
