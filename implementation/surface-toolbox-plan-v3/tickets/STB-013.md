# STB-013: Add Advanced accordion policy and Core Mode default
...
## Scope
Implement Add Advanced accordion policy and Core Mode default aligned to Plan v3 gates and anti-bloat rules.
