# STB-021: Selection priority and switchable selection profile

- Epic: ToolCursor
- Estimate: 3 points
- Dependencies: STB-020

## Scope
Implement Selection priority and switchable selection profile aligned to Plan v3 gates and anti-bloat rules.
