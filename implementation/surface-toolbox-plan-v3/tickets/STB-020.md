# STB-020: Implement unified tool-cursor interaction model

- Epic: ToolCursor
- Estimate: 8 points
- Dependencies: STB-011|STB-012

## Scope
Implement Implement unified tool-cursor interaction model aligned to Plan v3 gates and anti-bloat rules.
